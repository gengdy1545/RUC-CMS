...
public class CmsTypeController extends BaseController
{
    ...
    public AjaxResult getInfo(@PathVariable("typeId") Long typeId)
    {
        ...
        ajax.put("tags", cmsTagService.selectCmsTagList(new CmsTag()));
        if (StringUtils.isNotNull(typeId) && typeId>0)
        {
            ajax.put(AjaxResult.DATA_TAG, cmsTypeService.selectCmsTypeByTypeId(typeId));
        }
        return ajax;
    }
