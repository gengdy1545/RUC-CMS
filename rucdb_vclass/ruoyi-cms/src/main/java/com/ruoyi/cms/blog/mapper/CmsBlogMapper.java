...
public interface CmsBlogMapper 
{
     ...
     * 按分类查询文章管理列表
     */
    public List<CmsBlog> selectCmsBlogListByType(CmsType cmsType);
    ...
    List<Long> selectMenuListByBlogId(Long id);

    int batchBlogMenu(List<CmsBlogTag> blogTagList);

    void deleteMenuByBlogId(Long blogId);
}
